...
def episode():
    feed_dict = {
        ...
        'links': [
            {
                'href': 'https://dts.podtrac.com/redirect.mp3/chtbl.com/track/9EE2G/pdst.fm/e/'
                        'rss.art19.com/episodes/b58e6644-0b5d-492b-ad4a-a773bc701b81.mp3',
                'length': '4690337',
                'rel': 'enclosure',
                'type': 'audio/mpeg',
            }]}
...
def test_parse_RSS(episode: Episode):
    ...
    assert episode.download_link == 'https://dts.podtrac.com/redirect.mp3/chtbl.com/track/9EE2G/pdst.fm/e/' \
                                    'rss.art19.com/episodes/b58e6644-0b5d-492b-ad4a-a773bc701b81.mp3'
...
def test_path_calc(episode: Episode):
    ...
    episode.calculate_file_path(Path('testdirectory'))
...
def test_path_suffix(episode: Episode, test_value: str, expected: str):
    ...
    episode.calculate_file_path(Path('.'))
